...
class DnaGeneticsModel(db.Model):
    __tablename__ = "dnagenetics"
    dnagenetics_id = db.Column(UUID(as_uuid=True), default=uuid.uuid4, primary_key=True)
    ...
    def get_by_id(cls, id):
        return cls.query.filter_by(dnagenetics_id=id).first()
